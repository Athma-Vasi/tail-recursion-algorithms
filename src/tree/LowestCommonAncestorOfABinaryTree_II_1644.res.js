...
function lowestCommonAncestorOfABinaryTree_II(root, p, q) {
  ...
  var findLastMatchingElement = function (paths) {
    ...
    while(true) {
      ...
      var match = Core__Option.getOr(Array.from(matchSet.values()).at(0), Int32.min_int);
  ...
  var lca = findLastMatchingElement(Core__Array.reduceRight([
            p,
            q
          ], /* [] */0, (function (acc, curr) {
...
var r1 = lowestCommonAncestorOfABinaryTree_II(tree, 5, 1);

console.log("r1: ", r1);

var r2 = lowestCommonAncestorOfABinaryTree_II(tree, 5, 4);

console.log("r2: ", r2);

var r3 = lowestCommonAncestorOfABinaryTree_II(tree, 5, 10);

console.log("r3: ", r3);

export {
  lowestCommonAncestorOfABinaryTree_II ,
  tree ,
  r1 ,
  r2 ,
  r3 ,
